...
├── project_template             # The main python package for the project
...
do `pip install https://github.com/name/repo/tarball/{TAG|REVISION|COMMIT}`
...
e.g: `cat project_template/VERSION` will get the project version without harming
